...
<div id="alertas">
    ...
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
        <span>Houve algum problema cadastrar a categoria!</span>
	...
	<div class="alert alert-success alert-dismissible fade show" role="alert">
        <span>Categoria editada com sucesso!</span>
        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
    </div>
	<?php }else if(isset($_GET['retorno'])==true && $_GET['retorno']==5){ ?>
	<div class="alert alert-warning alert-dismissible fade show" role="alert">
		<span>Houve algum problema editar a categoria!</span>
        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
    </div>
	...
	<h4 class="titulos">Pesquisa de categorias</h4>
	
	<form action="#" method="GET" class="formAcao">
		<div class="form-group">		  		
			 <input placeholder="nome da categoria, ex.: computador" class="form-control" id="textoPesquisa" type="text" name="pesquisa">
