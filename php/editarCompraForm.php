...
<body>    
	...
	<h4 class="titulos">Consultar compra</h4>
	
	<form action="#" method="GET" class="formAcao">
		<div class="form-group">

		<label>Data da compra </label>	 
        <input class="form-control" id="textoPesquisa" type="date" name="data">
	...
	<table class="table">
        ...
        if($linhas==0){
            echo "<tr><tb colspan='6'>Nenhuma cliente foi encontrado!</tb></tr>";
        }else{
            while($c = mysqli_fetch_assoc($resultado)){
                array_push($clientesRetornados, $c);
            }
